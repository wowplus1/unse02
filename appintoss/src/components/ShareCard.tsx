...
// 캡처 안정성을 위해 전부 인라인 스타일 + 자체 배경(그라데이션)로 구성.
  ...
  return (
    <div
      ...
      style={{
        ...
        background: bg, color: "#fff", borderRadius: 26, padding: 24,
        boxShadow: "0 14px 40px rgba(226,120,150,.28)", overflow: "hidden",
    ...
    >
      ...
      <div style={{ textAlign: "center", padding: "14px 0 6px" }}>
        ...
        <div style={{
          display: "inline-block", marginTop: 10, background: "rgba(255,255,255,.22)",
      ...
      <div style={{ display: "flex", gap: 8 }}>
        {data.cats.map((c) => <MiniStat key={c.key} emoji={c.emoji} label={c.label} score={c.score} />)}
      </div>

      {/* 행운 */}
      <div style={{ display: "flex", gap: 8, marginTop: 8 }}>
        <div style={{ flex: 1, background: "rgba(255,255,255,.14)", borderRadius: 14, padding: "10px 12px", fontSize: 12.5 }}>
      ...
      <div style={{ background: "rgba(255,255,255,.14)", borderRadius: 14, padding: "10px 12px", fontSize: 12.5, marginTop: 8 }}>
